  ...
  Future<Either> getNewsSongs() async {
    try {
      ...
      for (var element in data.docs) {
        ...
        bool isFavortie = await sl<IsFavoretiSongsUseCase>()
            .call(params: element.reference.id);
        songModel.isFavorite = isFavortie;
    ...
    try {
      ...
      if (favoriteSongs.docs.isNotEmpty) {
        ...
        firebaseFirestore
            ...
            .doc(uId)
            .collection('Favorites')
            .add({'songsId': songId, 'addedDate': Timestamp.now()});
        isFavorite = true;
      }
